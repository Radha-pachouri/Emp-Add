...
public class EmpController {
    ...
    @PutMapping("emp/name/id/{empId}")
    public String updateEmployee(@PathVariable Long empId, @RequestParam String name){
        return empService.updateEmployeeName(empId , name);
    }
    @DeleteMapping("emp/id/{empId}")
